...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">维修保养管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>维修保养列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">维修保养列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									<label>
										维修单号
									</label>
									<input type="text" id="weixiudanhaoSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
									<label>
										用户名
									</label>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('weixiudanhao')">维修单号<i id="weixiudanhaoIcon" class="fa fa-sort"></i></th>
											...
											<th onclick="sort('weixiuxiangmu')">维修项目<i id="weixiuxiangmuIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('jine')">金额<i id="jineIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('weixiuriqi')">维修日期<i id="weixiuriqiIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#weixiudanhaoSearch').val() != null && $('#weixiudanhaoSearch').val() != ''){
				searchForm.weixiudanhao ="%" +  $('#weixiudanhaoSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("weixiubaoyang/page","GET",{
				page: pageIndex,
				limit: pageSize,
				sort: sortColumn,
				order: sortOrder,
				weixiudanhao : searchForm.weixiudanhao,	
		...
		function setDataRow(item,number){
			...
			var weixiudanhaoCell  = document.createElement('td');

						 weixiudanhaoCell.innerHTML = item.weixiudanhao;


			row.appendChild(weixiudanhaoCell);
			...
			var weixiuxiangmuCell  = document.createElement('td');

						 weixiuxiangmuCell.innerHTML = item.weixiuxiangmu;


			row.appendChild(weixiuxiangmuCell);
			var jineCell  = document.createElement('td');

						 jineCell.innerHTML = item.jine;


			row.appendChild(jineCell);
			var weixiuriqiCell  = document.createElement('td');

						  weixiuriqiCell.innerHTML = item.weixiuriqi;


			row.appendChild(weixiuriqiCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("weixiubaoyang/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"weixiubaoyang");
        ...
        function pay(id){
			...
			window.sessionStorage.setItem('tableName',"weixiubaoyang");
