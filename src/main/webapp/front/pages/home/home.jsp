...
<body>
    ...
    <div class="about-culture-box">
      <div class="about-culture">
        ...
        <div class="about-culture-piclist">
          <ul>
            <li v-for="(item,index) in qichexinxiList" v-bind:key="index" @click="jump('../qichexinxi/detail.jsp?id='+item.id)">
              <img :src="item.tupian?item.tupian.split(',')[0]:''" width="310" height="350" />
              <div class="about-culture-words">
                <h6>{{item.qichexinghao}}</h6>
  ...
  <script>
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery'], function() {
      ...
      http.request(`qichexinxi/list`, 'get', {
        page: 1,
        limit: 6
      }, function(res) {
        vue.qichexinxiList = res.data.list;
      });
    });
  </script>
</body>
