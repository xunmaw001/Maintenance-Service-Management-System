      ...
      <form class="layui-form" style="margin: 10px 0;">
        <div class="layui-inline">
          ...
          <div class="layui-input-inline">
            <input type="text" name="weixiudanhao" id="weixiudanhao" placeholder="维修单号" autocomplete="off" class="layui-input">
          </div>
        </div>   
        <div class="layui-inline">
        ...
        <div class="layui-inline" style="margin-left: 30px;">
          ...
          <button v-if="isAuth('weixiubaoyang','新增')" @click="jump('../weixiubaoyang/add.jsp')" type="button" class="layui-btn btn-theme">
      ...
      <div class="box">
        <ul class="clearfix">
          <li v-for="(item,index) in dataList" v-bind:key="index">
            <a :href="'../weixiubaoyang/detail.jsp?id='+item.id">
              <figure>
              </figure>
              <div class="div1">
                <b></b>
  ...
  <script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery'], function() {
      ...
      function pageList() {
        ...
        if (jquery('#weixiudanhao').val()) {
          param['weixiudanhao'] = jquery('#weixiudanhao').val() ? '%' + jquery('#weixiudanhao').val() + '%' : '';
        }  
        if (jquery('#yonghuming').val()) {
          param['yonghuming'] = jquery('#yonghuming').val() ? '%' + jquery('#yonghuming').val() + '%' : '';
        }  
        // 获取列表数据
        http.request('weixiubaoyang/list', 'get', param, function(res) {
